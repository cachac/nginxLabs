...
ab -n 1000 -c 300  -k  http://34.28.23.228:82/
```
- Requests per second:    561.15 [#/sec] (mean)  (before: 515)
- Time taken for tests:   1.782 seconds  (before: 1.9 seconds)
...
- Time taken for tests:   15.119 seconds (Before 15.79 seconds)
